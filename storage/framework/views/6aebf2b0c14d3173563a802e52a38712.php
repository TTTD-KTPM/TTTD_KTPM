<?php $__env->startComponent('admin::emails.layout'); ?>
    <div style="margin-bottom: 34px;">
        <span style="font-size: 22px;font-weight: 600;color: #121A26">
            <?php echo e(__('admin::app.emails.orders.refunded.title')); ?>
        ...
        <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
            <?php echo app('translator')->get('admin::app.emails.orders.refunded.greeting', [
    ...
    <div style="font-size: 20px;font-weight: 600;color: #121A26">
        <?php echo e(__('admin::app.emails.orders.refunded.summary')); ?>
        ...
        <?php if($refund->order->shipping_address): ?>
            <div style="line-height: 25px;">
                ...
                <div style="font-size: 16px;font-weight: 400;color: #384860;margin-bottom: 40px;">
                    ...
                    <?php echo e(__('admin::app.emails.orders.contact')); ?> : <?php echo e($refund->order->billing_address->phone); ?>
...
<?php /**PATH D:\xampp\htdocs\TTTD_KTPM_Clone\packages\Webkul\Admin\src\Resources\views\emails\orders\refunded.blade.php ENDPATH**/ ?>