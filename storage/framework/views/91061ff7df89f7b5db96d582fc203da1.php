...
<?php if (! $__env->hasRenderedOnce('6e00d433-1aa0-446b-a128-e9136057306b')): $__env->markAsRenderedOnce('6e00d433-1aa0-446b-a128-e9136057306b');
...
<?php $component->withAttributes(['class' => 'required']); ?>
                <?php echo e($title  ?? trans('shop::app.products.view.type.booking.slots.book-an-appointment')); ?>
...
<?php $component->withAttributes(['class' => 'hidden']); ?>
                        <?php echo app('translator')->get('shop::app.products.view.type.booking.slots.date'); ?>
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal2f2718777649517fc23f75e819ccd670)): ?>
<?php $attributes = $__attributesOriginal2f2718777649517fc23f75e819ccd670; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'shop::components.form.control-group.control','data' => ['type' => 'date','class' => 'py-4','name' => 'booking[date]','rules' => 'required','label' => trans('shop::app.products.view.type.booking.slots.date'),'placeholder' => trans('YYYY-MM-DD'),'dataMinDate' => 'today',':disable' => 'disabledDates','@change' => 'getAvailableSlots']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'date','class' => 'py-4','name' => 'booking[date]','rules' => 'required','label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('shop::app.products.view.type.booking.slots.date')),'placeholder' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('YYYY-MM-DD')),'data-min-date' => 'today',':disable' => 'disabledDates','@change' => 'getAvailableSlots']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'hidden']); ?>
                        <?php echo app('translator')->get('shop::app.products.view.type.booking.slots.title'); ?>
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal2f2718777649517fc23f75e819ccd670)): ?>
<?php $attributes = $__attributesOriginal2f2718777649517fc23f75e819ccd670; ?>
...
<?php endif; ?>
                    ...
                    <?php if (isset($component)) { $__componentOriginal03b54b937596232babb8a12a8847d013 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal03b54b937596232babb8a12a8847d013 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'shop::components.form.control-group.control','data' => ['type' => 'select','class' => 'py-4','name' => 'booking[slot]','rules' => 'required','vModel' => 'selectedSlot','label' => trans('shop::app.products.view.type.booking.slots.title'),'placeholder' => trans('shop::app.products.view.type.booking.slots.title')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('shop::form.control-group.control'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'select','class' => 'py-4','name' => 'booking[slot]','rules' => 'required','v-model' => 'selectedSlot','label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('shop::app.products.view.type.booking.slots.title')),'placeholder' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('shop::app.products.view.type.booking.slots.title'))]); ?>
                        <option value="">
                            <?php echo app('translator')->get('shop::app.products.view.type.booking.slots.select-slot'); ?>
                        </option>
                        
                        <option v-if="! slots?.length">
                            <?php echo app('translator')->get('shop::app.products.view.type.booking.slots.no-slots-available'); ?>
                        </option>
...
<?php /**PATH D:\xampp\htdocs\TTTD_KTPM_Clone\packages\Webkul\Shop\src\Resources\views\products\view\types\booking\slots.blade.php ENDPATH**/ ?>