...
<?php if (! $__env->hasRenderedOnce('8bb1b775-23f7-4d53-8992-02e0faaf5c8b')): $__env->markAsRenderedOnce('8bb1b775-23f7-4d53-8992-02e0faaf5c8b');
                    ...
                    if (params.booking_type === 'one') {
                        ...
                        if (
                            ...
                            this.$emitter.emit('add-flash', {
                                type: 'error',
                                message: "<?php echo app('translator')->get('admin::app.catalog.products.edit.types.booking.validations.time-validation'); ?>"
                            });
                        ...
                        if (! isOverlapping) {
                            ...
                            this.$emitter.emit('add-flash', {
                                type: 'error',
                                message: "<?php echo app('translator')->get('admin::app.catalog.products.edit.types.booking.validations.overlap-validation'); ?>",
                            });
...
<?php $__env->stopPush(); endif; ?><?php /**PATH D:\xampp\htdocs\TTTD_KTPM_Clone\packages\Webkul\Admin\src\Resources\views\catalog\products\edit\types\booking\default.blade.php ENDPATH**/ ?>