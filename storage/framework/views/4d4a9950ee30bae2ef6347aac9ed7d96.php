...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> 
        <?php echo app('translator')->get('admin::app.marketing.search-seo.sitemaps.index.title'); ?>
     <?php $__env->endSlot(); ?>

    <?php echo view_render_event('bagisto.admin.marketing.search_seo.sitemaps.create.before'); ?>
    ...
    <v-create-sitemaps>
        <div class="flex items-center justify-between gap-4 max-sm:flex-wrap">
            ...
            <!-- Create Button -->
            <?php if(bouncer()->hasPermission('marketing.search_seo.sitemaps.create')): ?>
                <div class="primary-button">
                    <?php echo app('translator')->get('admin::app.marketing.search-seo.sitemaps.index.create-btn'); ?>
                </div>
            <?php endif; ?>
        </div>
...
<?php endif; ?>
    ...
    <?php echo view_render_event('bagisto.admin.marketing.search_seo.sitemaps.create.after'); ?>


    <?php if (! $__env->hasRenderedOnce('3005bbdf-fb07-4f30-b9e2-7f33ad60e7bd')): $__env->markAsRenderedOnce('3005bbdf-fb07-4f30-b9e2-7f33ad60e7bd');
$__env->startPush('scripts'); ?>
        ...
        >
            ...
            <?php echo view_render_event('bagisto.admin.marketing.search_seo.sitemaps.list.before'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'admin::components.datagrid.index','data' => ['src' => route('admin.marketing.search_seo.sitemaps.index'),'ref' => 'datagrid']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['src' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.marketing.search_seo.sitemaps.index')),'ref' => 'datagrid']); ?>
                <template #body="{
                    isLoading,
                    available,
                    applied,
                    ...
                    <template v-else>
                        ...
                        >
                            ...
                            <div class="flex justify-end">
                                <?php if(bouncer()->hasPermission('marketing.search_seo.sitemaps.edit')): ?>
                                ...
                                <?php if(bouncer()->hasPermission('marketing.search_seo.sitemaps.delete')): ?>
...
<?php endif; ?>
            ...
            <?php echo view_render_event('bagisto.admin.marketing.search_seo.sitemaps.list.after'); ?>
...
<?php $component->withAttributes(['ref' => 'sitemap']); ?>
                        <!-- Modal Header -->
                         <?php $__env->slot('header', null, []); ?> 
                            ...
                            >
                                <?php echo app('translator')->get('admin::app.marketing.search-seo.sitemaps.index.edit.title'); ?>
                            </p>
                            ...
                            <p
                                ...
                                v-else
                            >
                                <?php echo app('translator')->get('admin::app.marketing.search-seo.sitemaps.index.create.title'); ?>
                            </p>
                         <?php $__env->endSlot(); ?>
...
<?php $component->withAttributes(['class' => 'required']); ?>
                                    <?php echo app('translator')->get('admin::app.marketing.search-seo.sitemaps.index.create.file-name'); ?>
                                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                ...
                                <?php if (isset($component)) { $__componentOriginal53af403f6b2179a3039d488b8ab2a267 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal53af403f6b2179a3039d488b8ab2a267 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'admin::components.form.control-group.control','data' => ['type' => 'text','name' => 'file_name','rules' => 'required','value' => old('file_name'),'label' => trans('admin::app.marketing.search-seo.sitemaps.index.create.file-name'),'placeholder' => trans('admin::app.marketing.search-seo.sitemaps.index.create.file-name')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('admin::form.control-group.control'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'text','name' => 'file_name','rules' => 'required','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('file_name')),'label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('admin::app.marketing.search-seo.sitemaps.index.create.file-name')),'placeholder' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('admin::app.marketing.search-seo.sitemaps.index.create.file-name'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal53af403f6b2179a3039d488b8ab2a267)): ?>
<?php $attributes = $__attributesOriginal53af403f6b2179a3039d488b8ab2a267; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'admin::components.form.control-group.error','data' => ['controlName' => 'file_name']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                                ...
                                <p class="mt-2 text-xs font-medium text-gray-600 dark:text-gray-300 ltr:ml-1 rtl:mr-1">
                                    <?php echo app('translator')->get('admin::app.marketing.search-seo.sitemaps.index.create.file-name-info'); ?>
                                </p>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'required']); ?>
                                    <?php echo app('translator')->get('admin::app.marketing.search-seo.sitemaps.index.create.path'); ?>
                                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal8378211f70f8c39b16d47cecdac9c7c8)): ?>
<?php $attributes = $__attributesOriginal8378211f70f8c39b16d47cecdac9c7c8; ?>
...
<?php endif; ?>
                                ...
                                <?php if (isset($component)) { $__componentOriginal53af403f6b2179a3039d488b8ab2a267 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal53af403f6b2179a3039d488b8ab2a267 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'admin::components.form.control-group.control','data' => ['type' => 'text','name' => 'path','rules' => 'required','value' => old('path'),'label' => trans('admin::app.marketing.search-seo.sitemaps.index.create.path'),'placeholder' => trans('admin::app.marketing.search-seo.sitemaps.index.create.path')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('admin::form.control-group.control'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'text','name' => 'path','rules' => 'required','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('path')),'label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('admin::app.marketing.search-seo.sitemaps.index.create.path')),'placeholder' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('admin::app.marketing.search-seo.sitemaps.index.create.path'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal53af403f6b2179a3039d488b8ab2a267)): ?>
<?php $attributes = $__attributesOriginal53af403f6b2179a3039d488b8ab2a267; ?>
...
<?php endif; ?>
                                ...
                                <?php if (isset($component)) { $__componentOriginal8da25fb6534e2ef288914e35c32417f8 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal8da25fb6534e2ef288914e35c32417f8 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'admin::components.form.control-group.error','data' => ['controlName' => 'path']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('admin::form.control-group.error'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
                                ...
                                <p class="mt-2 text-xs font-medium text-gray-600 dark:text-gray-300 ltr:ml-1 rtl:mr-1">
                                    <?php echo app('translator')->get('admin::app.marketing.search-seo.sitemaps.index.create.path-info'); ?>
                                </p>
                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal7b1bc76a00ab5e7f1bf2c6429dae85a3)): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'admin::components.button.index','data' => ['buttonType' => 'submit','class' => 'primary-button','title' => trans('admin::app.marketing.search-seo.sitemaps.index.create.save-btn'),':loading' => 'isLoading',':disabled' => 'isLoading']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['button-type' => 'submit','class' => 'primary-button','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('admin::app.marketing.search-seo.sitemaps.index.create.save-btn')),':loading' => 'isLoading',':disabled' => 'isLoading']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
            ...
            app.component('v-create-sitemaps', {
                ...
                methods: {
                    updateOrCreate(params, { resetForm, setErrors }) {
                        ...
                        this.$axios.post(params.id ? "<?php echo e(route('admin.marketing.search_seo.sitemaps.update')); ?>" : "<?php echo e(route('admin.marketing.search_seo.sitemaps.store')); ?>", formData )
                            .then((response) => {
...
<?php endif; ?>
<?php /**PATH D:\xampp\htdocs\TTTD_KTPM_Clone\packages\Webkul\Admin\src\Resources\views\marketing\search-seo\sitemaps\index.blade.php ENDPATH**/ ?>