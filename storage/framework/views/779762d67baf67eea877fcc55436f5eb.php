...
<?php endif; ?>
    ...
    <?php if (! $__env->hasRenderedOnce('34904ffa-4b6b-4cfc-b9ea-999bd4351b19')): $__env->markAsRenderedOnce('34904ffa-4b6b-4cfc-b9ea-999bd4351b19');
...
<?php $component->withAttributes(['type' => 'select','id' => 'swatchType','name' => 'swatch_type','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('swatch_type')),'v-model' => 'swatchType','@change' => 'showSwatch=true']); ?>
                                        <?php $__currentLoopData = $swatchTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $swatchType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($swatchType); ?>">
                                                <?php echo app('translator')->get('admin::app.catalog.attributes.create.option.' . $swatchType); ?>
                                            </option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes(['type' => 'select','id' => 'type','class' => 'cursor-pointer','name' => 'type','rules' => 'required','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('type')),'v-model' => 'attributeType','label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('admin::app.catalog.attributes.create.type')),'@change' => 'swatchAttribute=true']); ?>
                                    <?php $__currentLoopData = $attributeTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attributeType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option
                                            ...
                                            <?php echo e($attributeType === 'text' ? "selected" : ''); ?>

                                        >
                                            <?php echo app('translator')->get('admin::app.catalog.attributes.create.'. $attributeType); ?>
                                        </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes(['type' => 'select','class' => 'cursor-pointer','id' => 'validation','name' => 'validation','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('validation')),'v-model' => 'validationType','label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('admin::app.catalog.attributes.create.input-validation')),'refs' => 'validation','@change' => 'inputValidation=true']); ?>
                                    <?php $__currentLoopData = $validations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $validation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($validation); ?>">
                                            <?php echo app('translator')->get('admin::app.catalog.attributes.create.' . $validation); ?>
                                        </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes(['class' => '!mb-2 flex select-none items-center gap-2.5',':class' => '{ \'opacity-70\' : ! isConfigurable }']); ?>
                                <?php if (isset($component)) { $__componentOriginal53af403f6b2179a3039d488b8ab2a267 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal53af403f6b2179a3039d488b8ab2a267 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'admin::components.form.control-group.control','data' => ['type' => 'checkbox','id' => 'is_configurable','name' => 'is_configurable','value' => '1','for' => 'is_configurable',':disabled' => '! isConfigurable']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('admin::form.control-group.control'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'checkbox','id' => 'is_configurable','name' => 'is_configurable','value' => '1','for' => 'is_configurable',':disabled' => '! isConfigurable']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal53af403f6b2179a3039d488b8ab2a267)): ?>
<?php $attributes = $__attributesOriginal53af403f6b2179a3039d488b8ab2a267; ?>
...
<?php $component->withAttributes(['class' => '!mb-2 flex select-none items-center gap-2.5',':class' => '{ \'opacity-70\' : ! isFilterable }']); ?>
                                <?php if (isset($component)) { $__componentOriginal53af403f6b2179a3039d488b8ab2a267 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal53af403f6b2179a3039d488b8ab2a267 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'admin::components.form.control-group.control','data' => ['type' => 'checkbox','id' => 'is_filterable','name' => 'is_filterable','value' => '1','for' => 'is_filterable',':disabled' => '! isFilterable']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('admin::form.control-group.control'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'checkbox','id' => 'is_filterable','name' => 'is_filterable','value' => '1','for' => 'is_filterable',':disabled' => '! isFilterable']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal53af403f6b2179a3039d488b8ab2a267)): ?>
<?php $attributes = $__attributesOriginal53af403f6b2179a3039d488b8ab2a267; ?>
            ...
            app.component('v-create-attributes', {
                ...
                data() {
                    return {
                        ...
                        attributeType: '<?php echo e(old('type')); ?>',
...
<?php endif; ?>
<?php /**PATH D:\xampp\htdocs\TTTD_KTPM_Clone\packages\Webkul\Admin\src\Resources\views\catalog\attributes\create.blade.php ENDPATH**/ ?>