    ...
    <body dir="<?php echo e(core()->getCurrentLocale()->direction); ?>">
        ...
        <div class="page">
            ...
            <div class="page-header">
                <b><?php echo app('translator')->get('admin::app.sales.invoices.invoice-pdf.invoice'); ?></b>
            </div>
            ...
            <div class="page-content">
                ...
                <table class="<?php echo e(core()->getCurrentLocale()->direction); ?>">
                    <tbody>
                        <tr>
                            <?php if(core()->getConfigData('sales.invoice_settings.pdf_print_outs.invoice_id')): ?>
                                <td style="width: 50%; padding: 2px 18px;border:none;">
                                    <b>
                                        <?php echo app('translator')->get('admin::app.sales.invoices.invoice-pdf.invoice-id'); ?>:
                                    </b>
                            ...
                            <?php if(core()->getConfigData('sales.invoice_settings.pdf_print_outs.order_id')): ?>
                                <td style="width: 50%; padding: 2px 18px;border:none;">
                                    <b>
                                        <?php echo app('translator')->get('admin::app.sales.invoices.invoice-pdf.order-id'); ?>:
                                    </b>
                        ...
                        <tr>
                            <td style="width: 50%; padding: 2px 18px;border:none;">
                                <b>
                                    <?php echo app('translator')->get('admin::app.sales.invoices.invoice-pdf.date'); ?>:
                                </b>
                            ...
                            <td style="width: 50%; padding: 2px 18px;border:none;">
                                <b>
                                    <?php echo app('translator')->get('admin::app.sales.invoices.invoice-pdf.order-date'); ?>:
                                </b>
                            ...
                            <td style="width: 50%; padding: 2px 18px;border:none;">
                                <?php if($invoice->hasPaymentTerm()): ?>
                                    <div style="margin-bottom: 12px">
                                        <b style="display: inline-block; margin-bottom: 4px;">
                                            <?php echo app('translator')->get('admin::app.sales.invoices.invoice-pdf.payment-terms'); ?>:
                                        </b>
                    ...
                    <thead>
                        <tr>
                            <?php if($invoice->order->billing_address): ?>
                                <th style="width: 50%;">
                                    <b>
                                        <?php echo app('translator')->get('admin::app.sales.invoices.invoice-pdf.bill-to'); ?>
                                    </b>
                                </th>
                            <?php endif; ?>
                            ...
                            <?php if($invoice->order->shipping_address): ?>
                                <th style="width: 50%">
                                    <b>
                                        <?php echo app('translator')->get('admin::app.sales.invoices.invoice-pdf.ship-to'); ?>
                                    </b>
                                </th>
                            <?php endif; ?>
                        </tr>
                        ...
                        <tr>
                            <?php if($invoice->order->billing_address): ?>
                                <td style="width: 50%">
                                    ...
                                    <div><?php echo app('translator')->get('admin::app.sales.invoices.invoice-pdf.contact'); ?>: <?php echo e($invoice->order->billing_address->phone); ?></div>
                                </td>
                            <?php endif; ?>
                            ...
                            <?php if($invoice->order->shipping_address): ?>
                                <td style="width: 50%">
                                    ...
                                    <div><?php echo app('translator')->get('admin::app.sales.invoices.invoice-pdf.contact'); ?>: <?php echo e($invoice->order->shipping_address->phone); ?></div>
                                </td>
                            <?php endif; ?>
                        </tr>
                    </tbody>
                ...
                <table class="<?php echo e(core()->getCurrentLocale()->direction); ?>">
                    <thead>
                        <tr>
                            <th style="width: 50%">
                                <b>
                                    <?php echo app('translator')->get('admin::app.sales.invoices.invoice-pdf.payment-method'); ?>
                                </b>
                            </th>
                            ...
                            <?php if($invoice->order->shipping_address): ?>
                                <th style="width: 50%">
                                    <b>
                                        <?php echo app('translator')->get('admin::app.sales.invoices.invoice-pdf.shipping-method'); ?>
                                    </b>
                                </th>
                            <?php endif; ?>
                        </tr>
                ...
                <div class="items">
                    <table class="<?php echo e(core()->getCurrentLocale()->direction); ?>">
                        <thead>
                            <tr>
                                <th>
                                    <?php echo app('translator')->get('admin::app.sales.invoices.invoice-pdf.sku'); ?>
                                </th>

                                <th>
                                    <?php echo app('translator')->get('admin::app.sales.invoices.invoice-pdf.product-name'); ?>
                                </th>

                                <th>
                                    <?php echo app('translator')->get('admin::app.sales.invoices.invoice-pdf.price'); ?>
                                </th>

                                <th>
                                    <?php echo app('translator')->get('admin::app.sales.invoices.invoice-pdf.qty'); ?>
                                </th>

                                <th>
                                    <?php echo app('translator')->get('admin::app.sales.invoices.invoice-pdf.subtotal'); ?>
                                </th>
                            </tr>
                        </thead>
                                    ...
                                    <td>
                                        ...
                                        <?php elseif(core()->getConfigData('sales.taxes.sales.display_prices') == 'both'): ?>
                                            ...
                                            <div class="small-text">
                                                <?php echo app('translator')->get('admin::app.sales.invoices.invoice-pdf.excl-tax'); ?>
                ...
                <div class="summary">
                    <table class="<?php echo e(core()->getCurrentLocale()->direction); ?>">
                        <tbody>
                            ...
                            <?php elseif(core()->getConfigData('sales.taxes.sales.display_subtotal') == 'both'): ?>
                                <tr>
                                    <td><?php echo app('translator')->get('admin::app.sales.invoices.invoice-pdf.subtotal-incl-tax'); ?></td>
                                    <td>-</td>
                                    <td><?php echo core()->formatBasePrice($invoice->base_sub_total_incl_tax, true); ?></td>
                                </tr>

                                <tr>
                                    <td><?php echo app('translator')->get('admin::app.sales.invoices.invoice-pdf.subtotal-excl-tax'); ?></td>
                                    <td>-</td>
                            ...
                            <?php elseif(core()->getConfigData('sales.taxes.sales.display_shipping_amount') == 'both'): ?>
                                <tr>
                                    <td><?php echo app('translator')->get('admin::app.sales.invoices.invoice-pdf.shipping-handling-incl-tax'); ?></td>
                                    <td>-</td>
                                    <td><?php echo core()->formatBasePrice($invoice->base_shipping_amount_incl_tax, true); ?></td>
                                </tr>

                                <tr>
                                    <td><?php echo app('translator')->get('admin::app.sales.invoices.invoice-pdf.shipping-handling-excl-tax'); ?></td>
                                    <td>-</td>
                            ...
                            <tr>
                                <td style="border-top: 1px solid #FFFFFF;">
                                    <b><?php echo app('translator')->get('admin::app.sales.invoices.invoice-pdf.grand-total'); ?></b>
                                </td>
                ...
                <!-- Footer Content -->
                <?php if(core()->getConfigData('sales.invoice_settings.pdf_print_outs.footer_text')): ?>
                    <div>
                        <?php echo e(core()->getConfigData('sales.invoice_settings.pdf_print_outs.footer_text')); ?>
...
<?php /**PATH D:\xampp\htdocs\TTTD_KTPM_Clone\packages\Webkul\Admin\src\Resources\views\sales\invoices\pdf.blade.php ENDPATH**/ ?>