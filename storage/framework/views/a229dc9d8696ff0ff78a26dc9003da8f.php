<?php $__env->startComponent('admin::emails.layout'); ?>
    <div style="margin-bottom: 34px;">
        <span style="font-size: 22px;font-weight: 600;color: #121A26">
            <?php echo app('translator')->get('admin::app.emails.orders.canceled.title'); ?>
        </span> <br>
        ...
        <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
            <?php echo __('admin::app.emails.orders.canceled.greeting', [
    ...
    <div style="font-size: 20px;font-weight: 600;color: #121A26">
        <?php echo app('translator')->get('admin::app.emails.orders.canceled.summary'); ?>
    </div>
...
<?php /**PATH D:\xampp\htdocs\TTTD_KTPM_Clone\packages\Webkul\Admin\src\Resources\views\emails\orders\canceled.blade.php ENDPATH**/ ?>