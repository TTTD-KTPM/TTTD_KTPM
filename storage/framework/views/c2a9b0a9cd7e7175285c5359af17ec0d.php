...
<?php $component->withAttributes([]); ?>
    ...
    <?php echo view_render_event('bagisto.admin.marketing.notifications.create.before'); ?>


    <!-- Vue Component -->
    <v-notification-list>
        <!-- Shimmer Effect -->
        <?php if (isset($component)) { $__componentOriginalf4936efed31ecb931fddb2f5eb9d7be5 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf4936efed31ecb931fddb2f5eb9d7be5 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'admin::components.shimmer.notifications.index','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('admin::shimmer.notifications'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
...
<?php endif; ?>
<?php if (isset($__attributesOriginalf4936efed31ecb931fddb2f5eb9d7be5)): ?>
<?php $attributes = $__attributesOriginalf4936efed31ecb931fddb2f5eb9d7be5; ?>
<?php unset($__attributesOriginalf4936efed31ecb931fddb2f5eb9d7be5); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalf4936efed31ecb931fddb2f5eb9d7be5)): ?>
<?php $component = $__componentOriginalf4936efed31ecb931fddb2f5eb9d7be5; ?>
<?php unset($__componentOriginalf4936efed31ecb931fddb2f5eb9d7be5); ?>
<?php endif; ?>
    </v-notification-list>
    ...
    <?php if (! $__env->hasRenderedOnce('7f9f4555-f68c-4265-9398-af3235ee08b2')): $__env->markAsRenderedOnce('7f9f4555-f68c-4265-9398-af3235ee08b2');
                ...
                <div class="mb-5 flex items-center justify-between gap-4 max-sm:flex-wrap">
                    <div class="grid gap-1.5">
                        ...
                        <p class="text-gray-600 dark:text-gray-300">
                            <?php echo app('translator')->get('admin::app.notifications.description-text'); ?>
                        </p>
                    </div>
                </div>
                ...
                <div class="box-shadow flex h-[calc(100vh-179px)] max-w-max flex-col justify-between rounded-md bg-white dark:bg-gray-900">
                    <div>
                        ...
                        <div
                            ...
                            v-else
                        >
                            <?php echo app('translator')->get('admin::app.notifications.no-record'); ?>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-x-2 border-t p-4 dark:border-gray-800">
                        ...
                        <span class="whitespace-nowrap text-gray-600 dark:text-gray-300">
                            <?php echo app('translator')->get('admin::app.notifications.per-page'); ?>
                        </span>
                        ...
                        <span class="whitespace-nowrap text-gray-600 dark:text-gray-300">
                            <?php echo app('translator')->get('admin::app.notifications.of'); ?>
                        </span>
                ...
                data() {
                    return {
                        ...
                        orderType: {
                            all : {
                                icon: 'icon',
                                message: '<?php echo app('translator')->get('admin::app.notifications.order-status-messages.all'); ?>',
                                status: 'all'
                            },

                            pending : {
                                icon: 'icon-information bg-amber-100 text-amber-600 dark:!text-amber-600',
                                message: '<?php echo app('translator')->get('admin::app.notifications.order-status-messages.pending'); ?>',
                                status: 'pending'
                            },
...
<?php endif; ?>
<?php /**PATH D:\xampp\htdocs\TTTD_KTPM_Clone\packages\Webkul\Admin\src\Resources\views\notifications\index.blade.php ENDPATH**/ ?>