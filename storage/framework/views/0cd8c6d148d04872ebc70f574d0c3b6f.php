<?php $__env->startComponent('shop::emails.layout'); ?>
    ...
    <p style="font-size: 16px;color: #384860;line-height: 24px;">
        <?php echo app('translator')->get('shop::app.emails.customers.registration.credentials-description'); ?>
    </p>

    <p style="font-size: 16px;color: #384860;line-height: 24px;">
        <?php echo app('translator')->get('shop::app.emails.customers.registration.username-email'); ?> : <span><?php echo e($customer->email); ?></span>
    </p>

    <p style="font-size: 16px;color: #384860;line-height: 24px;">
        <?php echo app('translator')->get('shop::app.emails.customers.registration.password'); ?> : <?php echo e($password); ?>
...
<?php echo $__env->renderComponent(); ?><?php /**PATH D:\xampp\htdocs\TTTD_KTPM_Clone\packages\Webkul\Shop\src\Resources\views\emails\customers\new-customer.blade.php ENDPATH**/ ?>