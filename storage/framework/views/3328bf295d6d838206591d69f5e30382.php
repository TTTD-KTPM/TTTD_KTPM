<?php echo view_render_event('bagisto.admin.sales.order.create.recent_order_items.before'); ?>
...
<?php if (! $__env->hasRenderedOnce('6b101d2a-26ff-4739-9d0e-7f74827913f7')): $__env->markAsRenderedOnce('6b101d2a-26ff-4739-9d0e-7f74827913f7');
            ...
            <div class="box-shadow rounded bg-white dark:bg-gray-900">
                <div class="flex items-center justify-between p-4">
                    <p class="text-base font-semibold text-gray-800 dark:text-white">
                        <?php echo app('translator')->get('admin::app.sales.orders.create.recent-order-items.title'); ?>
                    </p>
                </div>
                    ...
                    >
                        ...
                        <div class="grid gap-1.5">
                            ...
                            <p class="text-gray-600 dark:text-gray-300">
                                {{ "<?php echo app('translator')->get('admin::app.sales.orders.create.recent-order-items.sku', ['sku' => ':replace']); ?>".replace(':replace', item.product.sku) }}
                            </p>
                            ...
                            >
                                ...
                                >
                                    <?php echo app('translator')->get('admin::app.sales.orders.create.recent-order-items.see-details'); ?>
                            ...
                            <div class="mt-2 flex items-center gap-2.5">
                                <a
                                    :href="'<?php echo e(route('admin.sales.orders.view', '')); ?>/' + item.order_id"
                                    class="cursor-pointer text-sm text-blue-600 transition-all hover:underline"
                                    target="_blank"
                                >
                                    <?php echo app('translator')->get('admin::app.sales.orders.create.recent-order-items.view'); ?>
                                </a>
                                ...
                                >
                                    <?php echo app('translator')->get('admin::app.sales.orders.create.recent-order-items.add-to-cart'); ?>
                                </button>
                            </div>
                        </div>
                    </div>
        ...
        app.component('v-recent-order-items', {
            ...
            methods: {
                get() {
                    ...
                    this.$axios.get("<?php echo e(route('admin.customers.customers.orders.recent_items', $cart->customer_id)); ?>")
                        .then(response => {
...
<?php $__env->stopPush(); endif; ?><?php /**PATH D:\xampp\htdocs\TTTD_KTPM_Clone\packages\Webkul\Admin\src\Resources\views\sales\orders\create\recent-order-items.blade.php ENDPATH**/ ?>