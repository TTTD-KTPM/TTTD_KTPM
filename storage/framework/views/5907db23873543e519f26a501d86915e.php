<?php $__env->startComponent('admin::emails.layout'); ?>
    <div style="margin-bottom: 34px;">
        <span style="font-size: 22px;font-weight: 600;color: #121A26">
            <?php echo app('translator')->get('admin::app.emails.orders.shipped.title'); ?>
        </span> <br>
    ...
    <div style="font-size: 20px;font-weight: 600;color: #121A26">
        <?php echo app('translator')->get('admin::app.emails.orders.shipped.summary'); ?>
    </div>
        ...
        <?php if($shipment->order->shipping_address): ?>
            <div style="line-height: 25px;">
                ...
                <div style="font-size: 16px; color: #384860;">
                    ...
                    <div>
                        <span>
                            <?php echo app('translator')->get('admin::app.emails.orders.tracking-number', ['tracking_number' => $shipment->track_number]); ?>
                        </span>
                    </div>
                </div>
...
<?php /**PATH D:\xampp\htdocs\TTTD_KTPM_Clone\packages\Webkul\Admin\src\Resources\views\emails\orders\shipped.blade.php ENDPATH**/ ?>