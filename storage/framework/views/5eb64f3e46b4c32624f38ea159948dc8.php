...
<?php if (! $__env->hasRenderedOnce('9de6c5ff-3d3e-47a0-bc29-c5776d7aa526')): $__env->markAsRenderedOnce('9de6c5ff-3d3e-47a0-bc29-c5776d7aa526');
...
<?php endif; ?>
                                                        ...
                                                        <?php if (isset($component)) { $__componentOriginal53af403f6b2179a3039d488b8ab2a267 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal53af403f6b2179a3039d488b8ab2a267 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'admin::components.form.control-group.control','data' => ['type' => 'text','class' => '!w-[100px]','id' => $inputName,'name' => $inputName,'rules' => 'required|numeric|min_value:0|max_value:' . $item->qty_ordered,'value' => $item->qty_to_ship,'label' => trans('admin::app.sales.shipments.create.qty-to-ship'),'dataOriginalQuantity' => ''.e($item->qty_to_ship).'',':disabled' => '\''.e(empty($sourceQty)).'\' || source != \''.e($inventorySource->id).'\'','ref' => $inputName]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('admin::form.control-group.control'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'text','class' => '!w-[100px]','id' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($inputName),'name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($inputName),'rules' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('required|numeric|min_value:0|max_value:' . $item->qty_ordered),'value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($item->qty_to_ship),'label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('admin::app.sales.shipments.create.qty-to-ship')),'data-original-quantity' => ''.e($item->qty_to_ship).'',':disabled' => '\''.e(empty($sourceQty)).'\' || source != \''.e($inventorySource->id).'\'','ref' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($inputName)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal53af403f6b2179a3039d488b8ab2a267)): ?>
<?php $attributes = $__attributesOriginal53af403f6b2179a3039d488b8ab2a267; ?>
...
<?php /**PATH D:\xampp\htdocs\TTTD_KTPM_Clone\packages\Webkul\Admin\src/resources/views/sales/shipments/create.blade.php ENDPATH**/ ?>